# this is the nice functions file for sdz orderbook bot 
import ccxt
import json 
import pandas as pd 
import numpy as np
...
'''
             ...
             timestamp   open   high    low  close   volume  sma20_5m   sig  support  resis     PC  lcBpc
0  2022-05-25 04:25:00  82.36  82.36  82.36  82.36   6220.0       NaN   NaN    81.05  85.19    NaN    NaN
1  2022-05-25 04:30:00  82.24  82.24  82.24  82.24      2.0       NaN   NaN    81.05  85.19  82.36  False
2  2022-05-25 04:35:00  82.09  82.19  81.92  82.19  10761.0       NaN   NaN    81.05  85.19  82.24  False
3  2022-05-25 04:40:00  82.19  82.19  82.19  82.19    760.0       NaN   NaN    81.05  85.19  82.19    NaN
4  2022-05-25 04:45:00  82.20  82.45  82.20  82.44  13171.0       NaN   NaN    81.05  85.19  82.19   True
..                 ...    ...    ...    ...    ...      ...       ...   ...      ...    ...    ...    ...
95 2022-05-25 12:20:00  81.27  81.37  81.18  81.35  14164.0   82.1020  SELL    81.05  85.19  81.18   True
96 2022-05-25 12:25:00  81.20  81.28  81.14  81.14   9451.0   82.0345  SELL    81.05  85.19  81.35  False
97 2022-05-25 12:30:00  81.13  81.17  81.05  81.05   1734.0   81.9830  SELL    81.05  85.19  81.14  False
98 2022-05-25 12:35:00  81.38  81.45  81.36  81.45   1403.0   81.9335  SELL    81.05  85.19  81.05   True
99 2022-05-25 12:40:00  81.08  81.19  81.08  81.19   6649.0   81.8560  SELL    81.05  85.19  81.45  False

----
            timestamp   open   high    low  close   volume  sma20_5m  sig  support  resis     PC  lcBpc
0  2022-05-25 04:20:00  3.080  3.080  3.073  3.074  17137.0       NaN  NaN    2.938  3.105    NaN    NaN
1  2022-05-25 04:25:00  3.074  3.074  3.064  3.065  19681.0       NaN  NaN    2.938  3.105  3.074  False
2  2022-05-25 04:30:00  3.077  3.080  3.071  3.080   9229.0       NaN  NaN    2.938  3.105  3.065   True
3  2022-05-25 04:35:00  3.077  3.079  3.056  3.056   6201.0       NaN  NaN    2.938  3.105  3.080  False
4  2022-05-25 04:40:00  3.061  3.073  3.061  3.073   9180.0       NaN  NaN    2.938  3.105  3.056   True
..                 ...    ...    ...    ...    ...      ...       ...  ...      ...    ...    ...    ...
95 2022-05-25 12:15:00  2.979  2.979  2.967  2.967  10936.0   2.96480  BUY    2.938  3.105  2.970  False
96 2022-05-25 12:20:00  2.966  2.968  2.966  2.967   2260.0   2.96275  BUY    2.938  3.105  2.967    NaN
97 2022-05-25 12:25:00  2.964  2.966  2.964  2.966   6253.0   2.96190  BUY    2.938  3.105  2.967  False
98 2022-05-25 12:30:00  2.952  2.981  2.952  2.981  12208.0   2.96210  BUY    2.938  3.105  2.966   True
99 2022-05-25 12:35:00  2.980  2.981  2.978  2.980   8968.0   2.96215  BUY    2.938  3.105  2.981  False
...
# max_loss = -55
    ...
    print(f'for symbol {symbol} side: {side} | entry_price: {entry_price} | lev: {leverage}')
    # short or long
