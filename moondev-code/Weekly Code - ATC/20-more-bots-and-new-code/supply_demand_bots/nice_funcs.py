# building a nice funcs file for 2023
...
def supply_demand_zones(symbol=symbol):
    ...
    df_15m = df_sma(symbol, '15m', sd_limit, sd_sma)
    #print(df_15m)
    ...
    # df_1h = df_sma(symbol, '1h', sd_limit, sd_sma)
    # #print(df_1h)
    ...
    # df_4h = df_sma(symbol, '4h', sd_limit, sd_sma)
    # #print(df_4h)
    ...
    # df_1d = df_sma(symbol, '1d', sd_limit, sd_sma)
    # #print(df_1d)
...
def ob_cont(symbol):
    ...
    ob_df.to_csv('jan23/orderbook_forever.csv', index=False)
...
def ob(symbol='uBTCUSD'):
    ...
    df2 = pd.read_csv('jan23/orderbook_bot.csv')
    ...
    df2.to_csv('jan23/orderbook_bot.csv', index=False)
...
def tape(symbol='uBTCUSD'):
    ...
    tape_df = pd.read_csv('jan23/tape_reader.csv')
    ...
    # get recent trades
    out = open('jan23/recent_trades.json', 'w')
    ...
    df = pd.read_json('dec22/recent_trades.json')
    df['datetime'] = df['datetime'].dt.strftime('%m/%d/%Y %H:%M:%S')
    ...
    tape_df.to_csv('jan23/tape_reader.csv', index=False)
