'''
this is is a different version of the supply and demand zones bot
this one takes into account the order book and the tape reading
...
schedule.every(3).seconds.do(sz_bot)
