...
- even better when i change the time interval to 2 mins... but has exposure the 99% of time. 
...
data = pd.read_csv('/Users/tc/Dropbox/dev/yt_vids/sept23/new-funding.csv')
